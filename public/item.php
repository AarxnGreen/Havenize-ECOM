...
<div class="container">
       ...
       <?php $query = query("SELECT * FROM products WHERE product_id =" . escape_string($_GET['product_id']));
...
<div class="row">
    ...
    <div class="col-md-7">
       <img class="img-responsive" src='../resources/templates/uploads/<?=$row['product_image'];?>' height='700' width='600' alt="">
